...
class Stage {
    ...
    CompileAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const buildResult = yield this.CallGulpRunAsync('tsc', this.TempFolderPath);
                const testResult = yield this.CallGulpRunAsync('nyc mocha -p tsconfig.json dist/test/index.js', this.TempFolderPath);
                const updateModuleResult = yield this.UpdateModuleAsync();
            }
            catch (error) {
